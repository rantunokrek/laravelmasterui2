                ...
                <div class="card-body">
                  <form action="{{route('subcategory.store')}}" method="post" >
                    ...
                    <div class="form-group">
                      ...
                      <input name="subcategory_name" type="text" value="{{old('subcategory_name')}}" class="form-control  @error('subcategory_name') is-invalid @enderror" id="exampleInputClassName1" aria-describedby="ClassNameHelp" placeholder="Enter Sub Category Name" required>
